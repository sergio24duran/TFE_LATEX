...
\captionsetup[figure]{format=boldformat}
\usepackage{fancyhdr} %Para establecer mi propio encabezado y pie de página
\usepackage[left=3cm,right=3cm,top=2.5cm,bottom=2.5cm]{geometry} % Mis márgenes
\setlength{\headheight}{14.0pt} %Ajusta el tamaño del encabezado
\setlength{\parindent}{0pt}
\usepackage{amsmath} %Para ecuaciones
%\usepackage{refcheck} %Para que aparezca el nombre que le doy a la ecuación
...
\makeindex
\usepackage{tocloft} %Para que tenga línea de puntos el índice
